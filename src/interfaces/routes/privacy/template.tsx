		...
		<div class="mx-auto max-w-5xl space-y-12 px-4 py-12 lg:px-8">
			...
			<Section id="collected-information" title="1. 取得する個人情報">
				<div class="space-y-4">
					...
					<p>
						また、本サイトへのアクセスに際して、IPアドレス、ブラウザの種類、アクセス日時、閲覧したページ等のアクセスログを、当社が利用するホスティング事業者のサービス上に記録します。
					</p>
				</div>
			</Section>
			...
			<Section id="purpose-of-use" title="2. 利用目的">
				<div class="space-y-4">
					...
					<ul class="list-disc space-y-1 pl-6">
						...
						<li>
							本サイトの安全な運営、不正アクセスや不正な送信の防止、障害の調査・対応のため
						</li>
					</ul>
					<p>
			...
			<Section id="outsourcing" title="4. 個人情報の取扱いの委託">
				<div class="space-y-4">
					...
					<p>
						当社は、本サイトのホスティングおよびお問い合わせメールの送信に、Cloudflare,
						Inc.（アメリカ合衆国）のサービスを利用しており、同社に個人情報の取扱いを委託しています。同社は、個人情報保護委員会規則で定める基準に適合する体制を整備しており、当社は個人情報保護法第28条の定めに従い、必要な措置を講じます。
					</p>
					<p>
						委託先である外国の事業者における個人情報の取扱いに関する情報（当該国の個人情報の保護に関する制度、当該事業者が講ずる措置等）は、お客様の求めに応じて、法令の定めるところにより提供します。
					</p>
				</div>
			</Section>
			...
			<Section id="retention-period" title="5. 保存期間">
				<p>
					当社は、取得した個人情報を、利用目的の達成に必要な期間に限り保存し、その後は遅滞なく削除または消去します。ただし、法令により保存が義務付けられている場合はこの限りではありません。なお、アクセスログは、ホスティング事業者のサービスで定められた保存期間の経過後に自動的に削除されます。
				</p>
			</Section>
			...
			<Section id="security-measures" title="6. 安全管理措置">
				<div class="space-y-4">
					...
					<ul class="list-disc space-y-1 pl-6">
						...
						<li>
							外国（アメリカ合衆国）において個人情報を取り扱う場合は、当該国の個人情報の保護に関する制度等を把握したうえで必要な措置を講じます（外的環境の把握）
						</li>
					</ul>
				</div>
			</Section>
